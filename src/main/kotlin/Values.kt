...
public fun <R> objectBinding(
    vararg dependencies: Observable,
    func: () -> R,
): ObjectBinding<R> = createObjectBinding(func, *dependencies)

public fun <T> ObservableValue<T>.booleanBinding(
    vararg dependencies: Observable,
    func: (T) -> Boolean,
): BooleanBinding = createBooleanBinding({ func(value) }, this, *dependencies)
...
public fun <T> ObservableValue<T>.longBinding(
    vararg dependencies: Observable,
    func: (T) -> Long,
): LongBinding = createLongBinding({ func(value) }, this, *dependencies)

public fun <T> ObservableValue<T>.floatBinding(
    vararg dependencies: Observable,
    func: (T) -> Float,
): FloatBinding = createFloatBinding({ func(value) }, this, *dependencies)

public fun <T> ObservableValue<T>.doubleBinding(
    vararg dependencies: Observable,
    func: (T) -> Double,
): DoubleBinding = createDoubleBinding({ func(value) }, this, *dependencies)

public fun <T> ObservableValue<T>.stringBinding(
    vararg dependencies: Observable,
    func: (T) -> String?,
): StringBinding = createStringBinding({ func(value) }, this, *dependencies)

public fun <T, R> ObservableValue<T>.objectBinding(
    vararg dependencies: Observable,
    func: (T) -> R,
): ObjectBinding<R> = createObjectBinding({ func(value) }, this, *dependencies)
...
public inline fun given(condition: ObservableBooleanValue): When = `when`(condition)
